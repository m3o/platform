...
require (
	...
	github.com/micro/micro/plugin/redis/broker/v3 v3.0.0-20210607151919-f5182646c5c6
	github.com/micro/micro/plugin/redis/stream/v3 v3.0.0-20210607151919-f5182646c5c6
