...
require (
	...
	github.com/micro/micro/plugin/redis/broker/v3 v3.0.0-20210520130624-50cf73430cc5
	github.com/micro/micro/plugin/redis/stream/v3 v3.0.0-20210520122853-b372eb8e9ce1
